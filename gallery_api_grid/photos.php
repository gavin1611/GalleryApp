...
<div class="container">
    ...
    echo "<a href='index.php'>My Albums Photos</a> / {$page_title}";
    echo "</h1>";

    $access_token=$_SESSION['fb_token'];
    $json_link = "https://graph.facebook.com/v2.3/me/photos?fields=source,images,name&access_token={$access_token}";
